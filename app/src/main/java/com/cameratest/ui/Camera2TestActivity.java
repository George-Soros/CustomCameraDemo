...
/**
 * 使用android.hardware.camera2.CameraManager的API，最新的API
 */

public class Camera2TestActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    void initView(){
        ...
        mSurfaceHolder.addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                initCamera2();
                Toast.makeText(Camera2TestActivity.this, "Created", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
                Toast.makeText(Camera2TestActivity.this, "Changed", Toast.LENGTH_SHORT).show();
            }
...
//                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA}, PERMISSION_CAMERA_TAG);
                Toast.makeText(this, "请打开拍照的权限", Toast.LENGTH_SHORT).show();
                return;
            }
            //打开摄像头
    ...
    private CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(CameraDevice camera, int error) {//发生错误
            Toast.makeText(Camera2TestActivity.this, "摄像头开启失败", Toast.LENGTH_SHORT).show();
        }
    };
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(mSurfaceHolder.getSurface(), mImageReader.getSurface()),
                ...
                public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
                    Toast.makeText(Camera2TestActivity.this, "配置失败", Toast.LENGTH_SHORT).show();
                }
            }, childHandler);
